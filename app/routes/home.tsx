...
import { Colaboraciones } from "~/components/website/Colaboraciones";
...
export function meta({}: Route.MetaArgs) {
  return [
    {
      title:
        "Concilio & Sarralde — Firma Boutique Internacional de Auditoría y Consultoría",
    },
    {
      name: "description",
      content:
    ...
    },
    {
      name: "keywords",
      content:
        "auditoría, consultoría, compliance, outsourcing, impuestos, firma boutique, Argentina, Buenos Aires, Tucumán, servicios profesionales, Concilio Sarralde",
    },
    ...
    // Canonical
    {
      tagName: "link",
      rel: "canonical",
      href: "https://www.concilioysarralde.com.ar",
    },
    ...
    {
      property: "og:title",
      content: "Concilio & Sarralde — Firma Boutique Internacional",
    },
    {
      property: "og:description",
      content:
        "Firma boutique internacional de auditoría, consultoría, compliance y servicios profesionales con alcance en más de 30 países.",
    },
    { property: "og:url", content: "https://www.concilioysarralde.com.ar" },
    {
      property: "og:image",
      content: "https://www.concilioysarralde.com.ar/assets/og-image.jpg",
    },
    ...
    },
    {
      ...
      content:
        "Firma boutique internacional de auditoría, consultoría, compliance y servicios profesionales.",
    },
    {
      name: "twitter:image",
      content: "https://www.concilioysarralde.com.ar/assets/og-image.jpg",
...
export default function Home() {
  return (
    <div className="bg-surface-dark text-white">
      <a
        href="#nosotros"
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-60 focus:bg-gold focus:px-4 focus:py-2 focus:text-surface-dark focus:font-bold"
      >
        Saltar al contenido
      </a>
      <Navbar />
