export function MapaSection() {
  return (
    <div className="overflow-hidden bg-dark px-5 py-[100px] md:px-[52px] print:min-h-[297mm] print:w-[210mm] print:break-after-page print:px-[16mm] print:py-[18mm]" id="global">
      <div className="mb-4 text-[15px] font-bold uppercase tracking-[4px] text-gold text-center">Presencia internacional</div>
      <h2 className="mb-5 text-[clamp(28px,3.5vw,50px)] font-bold leading-[1.08] tracking-[-0.5px] text-dark text-center">Alcance Global</h2>
