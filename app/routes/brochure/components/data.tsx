...
export const SSN_TAGS = ["Control","Asesoramiento técnico","Procedimientos acordados","Reservas técnicas","Relaciones técnicas","Requerimientos SSN","FFEP","Cumplimiento SRT"];
export const UIF_TAGS = ["Diagnóstico de controles internos","Revisión externa independiente","Informe REI","Sujetos Obligados","LA/FT/PT","Cumplimiento UIF"];
